...
namespace TollBooth
{
    public class FindLicensePlateText
    {
        ...
        private async Task<string> MakeOCRRequest(byte[] imageBytes)
        {
            ...
            var uriBase = Environment.GetEnvironmentVariable("https://tollboothvisioninit459.cognitiveservices.azure.com/");
            var apiKey = Environment.GetEnvironmentVariable("cb5bf73d1fa9403eaee2492bd9f8c8e8");
